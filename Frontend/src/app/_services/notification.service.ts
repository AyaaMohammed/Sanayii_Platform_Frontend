...
export class NotificationService {
  ...
  constructor(private http: HttpClient,private tokenService: TokenService) {
    ...
    this.hubConnection = new signalR.HubConnectionBuilder()
      .withUrl("https://websitesanayiiwebapi-gtbrejeacxbhcndw.uaenorth-01.azurewebsites.net/notificationHub")  // Replace with your Web API URL and Hub name
      .build();
  ...
  private baseURL = "https://websitesanayiiwebapi-gtbrejeacxbhcndw.uaenorth-01.azurewebsites.net/api/Notification";
