...
loginForm: FormGroup = new FormGroup({
  username: new FormControl('TestProject', [Validators.required, Validators.minLength(3)]),
  email: new FormControl('ayamohammednafed@gmail.com', [Validators.required, Validators.email]),
